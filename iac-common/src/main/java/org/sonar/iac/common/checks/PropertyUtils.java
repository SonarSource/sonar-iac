...
public final class PropertyUtils {
  ...
  public static <T extends Tree> Optional<T> get(@Nullable Tree tree, Set<String> key, Class<T> clazz) {
    return get(tree, key::contains).filter(clazz::isInstance).map(clazz::cast);
  }
