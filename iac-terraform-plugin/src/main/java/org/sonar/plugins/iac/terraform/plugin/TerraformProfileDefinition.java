...
public class TerraformProfileDefinition implements BuiltInQualityProfilesDefinition {
  ...
  public void define(Context context) {
    NewBuiltInQualityProfile profile = context.createBuiltInQualityProfile(TerraformPlugin.PROFILE_NAME, TerraformPlugin.LANGUAGE_KEY);
    BuiltInQualityProfileJsonLoader.load(profile, TerraformPlugin.REPOSITORY_KEY, SONAR_WAY_PATH);
