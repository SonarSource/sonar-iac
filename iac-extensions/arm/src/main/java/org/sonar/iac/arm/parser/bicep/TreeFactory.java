...
public class TreeFactory {
  ...
  public TypeDeclaration typeDeclaration(SyntaxToken type, Identifier name, SyntaxToken equ, StringLiteral typeExpression) {
    return new TypeDeclarationImpl(type, name, equ, typeExpression);
  }
