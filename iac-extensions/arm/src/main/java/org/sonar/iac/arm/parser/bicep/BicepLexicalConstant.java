...
public class BicepLexicalConstant {
  ...
  public static final String AMBIENT_TYPE_UNION = "array|bool|int|object|string";
  public static final String AMBIENT_TYPE = "(?:" + AMBIENT_TYPE_UNION + ")(?=\\s|\\)|,|\\z)";
  public static final String ARRAY_TYPE = "(?:" + AMBIENT_TYPE_UNION + "|" + IDENTIFIER_LITERAL + ")(?:\\[(" + NUMBER + ")*\\])+(?=\\s|\\)|,|\\z)";
