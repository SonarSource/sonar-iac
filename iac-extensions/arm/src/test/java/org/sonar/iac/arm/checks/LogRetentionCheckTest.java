...
class LogRetentionCheckTest {
  ...
  void shouldCheckLogRetentionAsSimplePropertyBicep(String type) {
    ...
    int endColumnForType = 9 + "typeN".length();
    BicepVerifier.verifyContent(content, check,
      ...
      issue(8, 9, 8, endColumnForType, "Omitting \"retentionDays\" results in a short log retention duration. Make sure it is safe here."));
  }
}
