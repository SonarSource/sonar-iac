...
resource Sensitive_Should_raise_issue_for_first_rule '${type}@dummy' = {
...
resource Sensitive_Should_raise_issue_for_second_rule '${type}@dummy' = {
...
resource Sensitive_Should_raise_issue_for_both_rules '${type}@dummy' = {
...
resource Compliant_Should_NOT_raise_issue_both_rules_are_compliant '${type}@dummy' = {
