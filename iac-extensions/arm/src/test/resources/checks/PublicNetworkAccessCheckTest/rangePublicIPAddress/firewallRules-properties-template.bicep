resource Sensitive_Should_raise_issue_for_whole_range '${type}@dummy' = {
  name: 'Sensitive: Should raise issue for whole range'
  resource Sensitive_Should_raise_issue_for_whole_range_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_missing_start '${type}@dummy' = {
  name: 'Sensitive: Should raise issue missing start'
  resource Sensitive_Should_raise_issue_missing_start_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_missing_end '${type}@dummy' = {
  ...
  resource Sensitive_Should_raise_issue_missing_end_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_IPs_10_0_0_0 '${type}@dummy' = {
  name: 'Sensitive: Should raise issue for IPs < 10.0.0.0'
  resource Sensitive_Should_raise_issue_for_IPs_10_0_0_0_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_IPs_10_255_255_255_and_100_64_0_0 '${type}@dummy' = {
  name: 'Sensitive: Should raise issue for IPs > 10.255.255.255 and < 100.64.0.0'
  resource Sensitive_Should_raise_issue_for_IPs_10_255_255_255_and_100_64_0_0_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_IPs_100_127_255_255_and_169_254_0_0 '${type}@dummy' = {
  name: 'Sensitive: Should raise issue for IPs > 100.127.255.255 and < 169.254.0.0'
  resource Sensitive_Should_raise_issue_for_IPs_100_127_255_255_and_169_254_0_0_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_IPs_169_254_255_255_and_172_16_0_0 '${type}@dummy' = {
  name: 'Sensitive: Should raise issue for IPs > 169.254.255.255 and < 172.16.0.0'
  resource Sensitive_Should_raise_issue_for_IPs_169_254_255_255_and_172_16_0_0_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_IPs_172_31_255_255_and_192_0_0_0 '${type}@dummy' = {
  name: 'Sensitive: Should raise issue for IPs > 172.31.255.255 and < 192.0.0.0'
  resource Sensitive_Should_raise_issue_for_IPs_172_31_255_255_and_192_0_0_0_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_IPs_192_0_0_255_and_192_0_2_0 '${type}@dummy' = {
  name: 'Sensitive: Should raise issue for IPs > 192.0.0.255 and < 192.0.2.0'
  resource Sensitive_Should_raise_issue_for_IPs_192_0_0_255_and_192_0_2_0_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_IPs_192_0_2_255_and_192_168_0_0 '${type}@dummy' = {
  name: 'Sensitive: Should raise issue for IPs > 192.0.2.255 and < 192.168.0.0'
  resource Sensitive_Should_raise_issue_for_IPs_192_0_2_255_and_192_168_0_0_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_IPs_192_168_255_255_and_198_18_0_0 '${type}@dummy' = {
  ...
  resource Sensitive_Should_raise_issue_for_IPs_192_168_255_255_and_198_18_0_0_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_IPs_198_19_255_255_and_198_51_100_0 '${type}@dummy' = {
  name: 'Sensitive: Should raise issue for IPs > 198.19.255.255 and < 198.51.100.0'
  resource Sensitive_Should_raise_issue_for_IPs_198_19_255_255_and_198_51_100_0_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_IPs_198_51_100_255_and_203_0_113_0 '${type}@dummy' = {
  name: 'Sensitive: Should raise issue for IPs > 198.51.100.255 and < 203.0.113.0'
  resource Sensitive_Should_raise_issue_for_IPs_198_51_100_255_and_203_0_113_0_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_IPs_203_0_113_255_and_240_0_0_0 '${type}@dummy' = {
  name: 'Sensitive: Should raise issue for IPs > 203.0.113.255 and < 240.0.0.0'
  resource Sensitive_Should_raise_issue_for_IPs_203_0_113_255_and_240_0_0_0_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_IPs_240_255_255_254_and_255_255_255_255 '${type}@dummy' = {
  ...
  resource Sensitive_Should_raise_issue_for_IPs_240_255_255_254_and_255_255_255_255_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_IPs_240_255_255_254_no_endIpAddress '${type}@dummy' = {
  ...
  resource Sensitive_Should_raise_issue_for_IPs_240_255_255_254_no_endIpAddress_dummy 'firewallRules@2014-04-01' = {
...
resource type_Sensitive_Should_raise_issue_for_IPs_192_0_0_0_and_192_0_2_255_IP_ranges_edges_for_2_different_groups_between_are_public_addresses '${type}@dummy' = {
  ...
  resource type_firewallRules_Sensitive_Should_raise_issue_for_IPs_192_0_0_0_and_192_0_2_255_IP_ranges_edges_for_2_different_groups_between_are_public_addresses_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_unknown_startIpAddress '${type}@dummy' = {
  name: 'Sensitive: Should raise issue for unknown startIpAddress'
  resource Sensitive_Should_raise_issue_for_unknown_startIpAddress_dummy 'firewallRules@2014-04-01' = {
...
resource Sensitive_Should_raise_issue_for_unknown_endIpAddress '${type}@dummy' = {
  ...
  resource Sensitive_Should_raise_issue_for_unknown_endIpAddress_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_private_networks_only_1 '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for private networks only 1'
  resource Compliant_Should_NOT_raise_issue_for_private_networks_only_1_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_used_within_an_ISP_s_network_for_carrier_grade_NAT '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for used within an ISP’s network for carrier-grade NAT'
  resource Compliant_Should_NOT_raise_issue_for_used_within_an_ISP_s_network_for_carrier_grade_NAT_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_link_local_addresses_for_DHCP_failures '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for link-local addresses for DHCP failures'
  resource Compliant_Should_NOT_raise_issue_for_link_local_addresses_for_DHCP_failures_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_private_networks_only_2 '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for private networks only 2'
  resource Compliant_Should_NOT_raise_issue_for_private_networks_only_2_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_reserved_for_IETF_protocol_assignments '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for reserved for IETF protocol assignments'
  resource Compliant_Should_NOT_raise_issue_for_reserved_for_IETF_protocol_assignments_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_reserved_for_documentation_use_1 '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for reserved for documentation use 1'
  resource Compliant_Should_NOT_raise_issue_for_reserved_for_documentation_use_1_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_private_networks_only_3 '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for private networks only 3'
  resource Compliant_Should_NOT_raise_issue_for_private_networks_only_3_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_reserved_for_inter_subnet_benchmarking '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for reserved for inter-subnet benchmarking'
  resource Compliant_Should_NOT_raise_issue_for_reserved_for_inter_subnet_benchmarking_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_reserved_for_documentation_use_2 '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for reserved for documentation use 2'
  resource Compliant_Should_NOT_raise_issue_for_reserved_for_documentation_use_2_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_reserved_for_documentation_use_3 '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for reserved for documentation use 3'
  resource Compliant_Should_NOT_raise_issue_for_reserved_for_documentation_use_3_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_reserved_for_future_use '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for reserved for future use'
  resource Compliant_Should_NOT_raise_issue_for_reserved_for_future_use_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_reserved_for_future_use_part_of_range '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for reserved for future use (part of range)'
  resource Compliant_Should_NOT_raise_issue_for_reserved_for_future_use_part_of_range_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_unknown_value '${type}@dummy' = {
  ...
  resource Compliant_Should_NOT_raise_issue_for_unknown_value_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_IP_6 '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for IP 6'
  resource Compliant_Should_NOT_raise_issue_for_IP_6_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_missing_startIpAddress_and_endIpAddress '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for missing startIpAddress and endIpAddress'
  resource Compliant_Should_NOT_raise_issue_for_missing_startIpAddress_and_endIpAddress_dummy 'firewallRules@2014-04-01' = {
    name: 'Compliant: Should NOT raise issue for missing startIpAddress and endIpAddress/dummy'
    properties: {}
  }
}

resource Compliant_Should_NOT_raise_issue_for_startIpAddress_as_not_StringLiteral '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for startIpAddress as not StringLiteral'
  resource Compliant_Should_NOT_raise_issue_for_startIpAddress_as_not_StringLiteral_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_endIpAddress_as_not_StringLiteral '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for endIpAddress as not StringLiteral'
  resource Compliant_Should_NOT_raise_issue_for_endIpAddress_as_not_StringLiteral_dummy 'firewallRules@2014-04-01' = {
...
resource Compliant_Should_NOT_raise_issue_for_startIpAddress_endIpAddress_as_not_StringLiteral '${type}@dummy' = {
  name: 'Compliant: Should NOT raise issue for startIpAddress & endIpAddress as not StringLiteral'
  resource Compliant_Should_NOT_raise_issue_for_startIpAddress_endIpAddress_as_not_StringLiteral_dummy 'firewallRules@2014-04-01' = {
