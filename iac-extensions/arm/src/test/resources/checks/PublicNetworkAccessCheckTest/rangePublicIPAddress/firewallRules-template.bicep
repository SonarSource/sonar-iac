...
resource Compliant_Should_NOT_raise_issue_for_private_networks_only '${type}@dummy' = {
...
resource type_Compliant_Should_NOT_raise_issue_for_private_networks_only_1 '${type}@dummy' = {
...
resource type_Compliant_Should_NOT_raise_issue_for_reserved_for_documentation_use_1 '${type}@dummy' = {
