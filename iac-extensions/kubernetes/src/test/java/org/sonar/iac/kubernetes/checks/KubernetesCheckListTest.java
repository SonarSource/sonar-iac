...
class KubernetesCheckListTest {
  ...
  void count() {
    ...
    for (String folder : new String[] { "src/main/java/org/sonar/iac/kubernetes/checks/"}) {
    ...
    assertThat(KubernetesCheckList.checks()).hasSize(count);
  }
  ...
  @Test
  void has_test() {
    List<Class<?>> checks = KubernetesCheckList.checks();
