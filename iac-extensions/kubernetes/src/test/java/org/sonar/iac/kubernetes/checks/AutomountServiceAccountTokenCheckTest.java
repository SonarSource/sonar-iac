...
class AutomountServiceAccountTokenCheckTest {
  ...
  void shouldRaiseSecondaryLocationOnLinkedAccount() {
    ...
    var secondaryLocation2 = new SecondaryLocation(TextRanges.range(6, 30, 6, 34), "Change this setting",
      "AutomountServiceAccountTokenCheck/LinkedAccount/NonCompliant/SensitiveValue/linked_account_service_token.yaml");
