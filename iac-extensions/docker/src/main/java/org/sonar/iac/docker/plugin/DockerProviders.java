...
public class DockerProviders {
  ...
  private static final Logger LOG = Loggers.get(DockerProviders.class);
  ...
  public DockerProviders(SensorContext sensorContext, AnalysisWarnings analysisWarnings) {
  ...
  public static final class Provider {
    ...
    public enum Identifier {
      AWS("sonar.docker.provider.aws.version", "AWS"),
      AZURE("sonar.docker.provider.azure.version", "Azure");
