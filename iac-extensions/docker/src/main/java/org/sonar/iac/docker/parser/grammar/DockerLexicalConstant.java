...
public class DockerLexicalConstant {
  ...
  public static final String STRING_LITERAL_WITHOUT_QUOTES_NO_COLON = "[^\\s:]+";
  public static final String STRING_LITERAL = "(?:" + STRING_LITERAL_WITH_QUOTES + ")|(?:" + STRING_LITERAL_WITHOUT_QUOTES + ")";
  public static final String STRING_LITERAL_NO_COLON = "(?:" + STRING_LITERAL_WITH_QUOTES + ")|(?:" + STRING_LITERAL_WITHOUT_QUOTES_NO_COLON + ")";
