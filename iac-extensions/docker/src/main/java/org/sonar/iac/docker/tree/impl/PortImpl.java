...
public class PortImpl extends AbstractDockerTreeImpl implements Port {
  ...
  public PortImpl(SyntaxToken portMin, @Nullable SyntaxToken separatorPort, SyntaxToken portMax, @Nullable SyntaxToken separatorProtocol, @Nullable SyntaxToken protocol) {
