...
RUN ["sh", "-c", "other command; wget --secure-protocol SSLv2 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --secure-protocol SSLv2 https://tls-v1-0.badssl.com:1010; other command"]
RUN ["sh", "-c", "other command && wget --secure-protocol SSLv2 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --secure-protocol SSLv2 https://tls-v1-0.badssl.com:1010 && other command"]
RUN ["sh", "-c", "other command | wget --secure-protocol SSLv2 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --secure-protocol SSLv2 https://tls-v1-0.badssl.com:1010 | other command"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol SSLv2 https://tls-v1-0.badssl.com:1010 && other command"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol SSLv2 https://tls-v1-0.badssl.com:1010 && other command"]
RUN ["sh", "-c", "other command | wget --secure-protocol SSLv2 https://tls-v1-0.badssl.com:1010"]
...
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol $SSLV2_VERSION_ENV     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol ${SSLV2_VERSION_ENV}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol \"${SSLV2_VERSION_ENV}\" https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" $FLAG_AND_SSLV2_VERSION_ENV     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" ${FLAG_AND_SSLV2_VERSION_ENV}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" \"${FLAG_AND_SSLV2_VERSION_ENV}\" https://tls-v1-0.badssl.com:1010"]

ARG SSLV2_VERSION_ARG=SSLv2
ARG FLAG_AND_SSLV2_VERSION_ARG="--secure-protocol=${SSLV2_VERSION_ARG}"
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol $SSLV2_VERSION_ARG     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol ${SSLV2_VERSION_ARG}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol \"${SSLV2_VERSION_ARG}\" https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" $FLAG_AND_SSLV2_VERSION_ARG     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" ${FLAG_AND_SSLV2_VERSION_ARG}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" \"${FLAG_AND_SSLV2_VERSION_ARG}\" https://tls-v1-0.badssl.com:1010"]

RUN ["sh", "-c", "other command; wget --secure-protocol SSLv3 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --secure-protocol SSLv3 https://tls-v1-0.badssl.com:1010; other command"]
RUN ["sh", "-c", "other command && wget --secure-protocol SSLv3 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --secure-protocol SSLv3 https://tls-v1-0.badssl.com:1010 && other command"]
RUN ["sh", "-c", "other command | wget --secure-protocol SSLv3 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --secure-protocol SSLv3 https://tls-v1-0.badssl.com:1010 | other command"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol SSLv3 https://tls-v1-0.badssl.com:1010 && other command"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol SSLv3 https://tls-v1-0.badssl.com:1010 && other command"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol=SSLv3 https://tls-v1-0.badssl.com:1010 && other command"]

ENV SSLV3_VERSION_ENV=SSLv3
ENV FLAG_SSLV3_VERSION_ENV="--secure-protocol=${SSLV3_VERSION_ENV}"
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol $SSLV3_VERSION_ENV     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol ${SSLV3_VERSION_ENV}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol \"${SSLV3_VERSION_ENV}\" https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" $FLAG_SSLV3_VERSION_ENV     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" ${FLAG_SSLV3_VERSION_ENV}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" \"${FLAG_SSLV3_VERSION_ENV}\" https://tls-v1-0.badssl.com:1010"]

ARG SSLV3_VERSION_ARG=SSLv3
ARG FLAG_AND_SSLV3_VERSION_ARG="--secure-protocol=SSLv3"
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol $SSLV3_VERSION_ARG     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol ${SSLV3_VERSION_ARG}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol \"${SSLV3_VERSION_ARG}\" https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" $FLAG_AND_SSLV3_VERSION_ARG     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" ${FLAG_AND_SSLV3_VERSION_ARG}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" \"${FLAG_AND_SSLV3_VERSION_ARG}\" https://tls-v1-0.badssl.com:1010"]

RUN ["sh", "-c", "other command; wget --secure-protocol TLSv1 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --secure-protocol TLSv1 https://tls-v1-0.badssl.com:1010; other command"]
RUN ["sh", "-c", "other command && wget --secure-protocol TLSv1 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --secure-protocol TLSv1 https://tls-v1-0.badssl.com:1010 && other command"]
RUN ["sh", "-c", "other command | wget --secure-protocol TLSv1 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --secure-protocol TLSv1 https://tls-v1-0.badssl.com:1010 | other command"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol TLSv1 https://tls-v1-0.badssl.com:1010 && other command"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol TLSv1 https://tls-v1-0.badssl.com:1010 && other command"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol=TLSv1 https://tls-v1-0.badssl.com:1010 && other command"]
RUN ["sh", "-c", "other command | wget --secure-protocol SSLv3 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "other command | wget --secure-protocol SSLv3 https://tls-v1-0.badssl.com:1010"]
...
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol $TLSV1_VERSION_ENV     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol ${TLSV1_VERSION_ENV}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol \"${TLSV1_VERSION_ENV}\" https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" $FLAG_AND_TLSV1_VERSION_ENV     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" ${FLAG_AND_TLSV1_VERSION_ENV}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" \"${FLAG_AND_TLSV1_VERSION_ENV}\" https://tls-v1-0.badssl.com:1010"]

ARG TLSV1_VERSION_ARG=TLSv1
ARG FLAG_AND_TLSV1_VERSION_ARG="--secure-protocol=${TLSV1_VERSION_ARG}"
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol $TLSV1_VERSION_ARG     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol ${TLSV1_VERSION_ARG}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol \"${TLSV1_VERSION_ARG}\" https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" $FLAG_AND_TLSV1_VERSION_ARG     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" ${FLAG_AND_TLSV1_VERSION_ARG}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" \"${FLAG_AND_TLSV1_VERSION_ARG}\" https://tls-v1-0.badssl.com:1010"]

RUN ["sh", "-c", "other command; wget --secure-protocol TLSv1_1 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --secure-protocol TLSv1_1 https://tls-v1-0.badssl.com:1010; other command"]
RUN ["sh", "-c", "other command && wget --secure-protocol TLSv1_1 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --secure-protocol TLSv1_1 https://tls-v1-0.badssl.com:1010 && other command"]
RUN ["sh", "-c", "other command | wget --secure-protocol TLSv1_1 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --secure-protocol TLSv1_1 https://tls-v1-0.badssl.com:1010 | other command"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol TLSv1_1 https://tls-v1-0.badssl.com:1010 && other command"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol TLSv1_1 https://tls-v1-0.badssl.com:1010 && other command"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol=TLSv1_1 https://tls-v1-0.badssl.com:1010 && other command"]

ENV TLSV11_VERSION_ENV=TLSv1_1
ENV FALG_AND_TLSV11_VERSION_ENV="--secure-protocol=${TLSV11_VERSION_ENV}"
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol $TLSV11_VERSION_ENV     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol ${TLSV11_VERSION_ENV}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol \"${TLSV11_VERSION_ENV}\" https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" $FALG_AND_TLSV11_VERSION_ENV     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" ${FALG_AND_TLSV11_VERSION_ENV}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" \"${FALG_AND_TLSV11_VERSION_ENV}\" https://tls-v1-0.badssl.com:1010"]

ARG TLSV11_VERSION_ARG=TLSv1_1
ARG FLAG_AND_TLSV11_VERSION_ARG="--secure-protocol=TLSv1_1"
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol $TLSV11_VERSION_ARG     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol ${TLSV11_VERSION_ARG}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol \"${TLSV11_VERSION_ARG}\" https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" $FLAG_AND_TLSV11_VERSION_ARG     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" ${FLAG_AND_TLSV11_VERSION_ARG}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" \"${FLAG_AND_TLSV11_VERSION_ARG}\" https://tls-v1-0.badssl.com:1010"]

RUN ["sh", "-c", "other command | wget --secure-protocol TLSv1_1 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "other command | wget --secure-protocol TLSv1_1 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget https://www.sonarsource.com && wget --user-agent \"Mozilla\" --secure-protocol TLSv1_1 https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget https://www.sonarsource.com && other command && wget --user-agent \"Mozilla\" --secure-protocol TLSv1_1 https://tls-v1-0.badssl.com:1010 other command"]
...
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol $UNKNOWN    https://tls-v1-0.badssl.com:1010"]
...
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol $TLS_12_ENV   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol ${TLS_12_ENV} https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol $AUTO_ENV     https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol ${AUTO_ENV}   https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol $PFS_ENV      https://tls-v1-0.badssl.com:1010"]
RUN ["sh", "-c", "wget --user-agent \"Mozilla\" --secure-protocol ${PFS_ENV}    https://tls-v1-0.badssl.com:1010"]
