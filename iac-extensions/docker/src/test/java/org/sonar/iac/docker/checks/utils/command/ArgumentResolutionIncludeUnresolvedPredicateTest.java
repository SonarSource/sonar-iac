...
class ArgumentResolutionIncludeUnresolvedPredicateTest {

  @Test
  void shouldCheckType() {
    ArgumentResolutionIncludeUnresolvedPredicate predicate = new ArgumentResolutionIncludeUnresolvedPredicate(arg -> true, CommandPredicate.Type.MATCH);
