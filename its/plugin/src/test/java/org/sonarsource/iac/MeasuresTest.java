...
public class MeasuresTest extends TestBase {
  ...
  // TODO SONARIAC-81: CloudFormation sensor should not ignore empty files
  @Test
  public void cloudformation_yaml_measures() {
    ...
    //final String emptyFile = projectKey + ":empty.yaml";
  ...
  public void cloudformation_json_measures() {
    ...
    //final String emptyFile = projectKey + ":empty.json";
