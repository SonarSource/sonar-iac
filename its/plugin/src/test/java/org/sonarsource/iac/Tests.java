...
public class Tests {
  ...
  public static final FileLocation IAC_PLUGIN_LOCATION = FileLocation.byWildcardMavenFilename(new File("../../iac-terraform-plugin/target"), "iac-terraform-plugin-*.jar");
